...
public class ProjectControllerTest {
  ...
  public void getProjectsThatUserIsIn() {
    ...
    Assert.assertEquals(
        "correct projects for user 1",
        expectedUser1Projects.toString(),
        actualUser1Projects.toString());
    Assert.assertEquals(
        "correct projects for user 2",
        expectedUser2Projects.toString(),
        actualUser2Projects.toString());
    Assert.assertEquals(
        "correct projects for user 3",
        expectedUser3Projects.toString(),
        actualUser3Projects.toString());
    Assert.assertEquals(
        "correct projects for user 4",
        expectedUser4Projects.toString(),
        actualUser4Projects.toString());
  }
}
