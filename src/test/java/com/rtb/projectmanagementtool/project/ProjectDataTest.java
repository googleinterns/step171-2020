...
public class ProjectDataTest {
  ...
  public void createProject() {
    ...
    Assert.assertTrue(testProject.getUserIds().keySet().contains(projectCreator));
  ...
  public void addUserByType() {
    ...
    Assert.assertEquals(regularType, testProject.getUserIds().get(1l).name());
    testProject.addAdminUser(2l);
    Assert.assertEquals(adminType, testProject.getUserIds().get(2l).name());
  }
}
