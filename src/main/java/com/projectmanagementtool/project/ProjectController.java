...
public class ProjectController {
    ...
    */
    ...
    /**
    * Initializes the projects HashSet by retrieving all datastore entities 
    * of type "Project"
    */
    ...
    * First creates the Project entity and then creates the project object with the projectId
    * returned by createProjectEntity()
    *
    ...
    */
    ...
    /**
    * Removes a Project from web application; 
    * calls removeProjectEntity to remove the project from datastore. If successful,
    * removes the project from HashSet
    *
    ...
    */
    ...
    /**
    * Removes a Project Entity from datastore
    * (?) should this be done in the Data layer?
    *
    * @param projectId the id of the project to remove
    * @return true if the removal is successful
    */
    private boolean removeProjectEntity(long projectId) {
        try {
            ...
            System.out.println("Error: Project with projectId " + projectId + " does not exist. Key invalid");
            return false;
        }   
    }

    /**
    * Retrieves the Project object with the matching projectId from HashSet, 
    * or nothing if the project is not found
    *
