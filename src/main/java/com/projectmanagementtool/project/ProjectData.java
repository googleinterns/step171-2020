...
public class ProjectData {
    /** 
    * constant variables used to specify the names of each property of the Project entity. 
    * Used to minimize redundancy and also make renaming properties easy if needed
    */
    final private String PROPERTY_NAME = "name";
    final private String PROPERTY_DESCRIPTION = "description";
    final private String PROPERTY_USER_IDS = "userIds";
    final private String PROPERTY_TASK_IDS = "taskIds";
    ...
    * ? separate this into addAdminUser and addRegularUser?
    *
